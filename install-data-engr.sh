...
# [A cross\-platform, efficient and practical CSV/TSV toolkit in Golang](https://github.com/shenwei356/csvtk)
...
#
# * Structured Diff for tables: https://paulfitz.github.io/daff/
#
